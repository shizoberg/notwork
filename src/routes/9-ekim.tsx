...
const eventConfig: EventProductConfig = {
  ...
  gallery: [
    ...
    {
      src: "/events/9-ekim/rene-lokal-2.mp4",
      poster: "/events/9-ekim/rene-lokal-2-poster.jpg",
      alt: "9 Ekim notwork Classic etkinlik mekânı Rene Lokal bar alanı",
      label: "mekân",
      mediaType: "video",
      title: "rene lokal",
      subtitle: "bornova · izmir",
      position: "center",
    },
    {
